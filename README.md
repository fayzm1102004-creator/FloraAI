...
FloraAI is a comprehensive full-stack application designed to diagnose plant pathogens and diseases using machine learning. By capturing an image of a plant leaf, users can receive instant, AI-driven diagnostics and care recommendations.
...
* **AI Models (`AI/`)**: Machine learning models trained to classify various plant diseases.
